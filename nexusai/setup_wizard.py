"""
Interactive first-time setup wizard for nexusai.
"""
...
class SetupWizard:
    ...
    def run(self):
        ...
        print("  nexusai Setup")
        print("=" * 60)
        print("\nThis wizard will create ~/.nexusai/config.yaml")
        print("You can re-run 'nexusai setup' at any time to reconfigure.\n")
        ...
        print("\nRun 'nexusai start' to launch nexusai.")
        print("=" * 60 + "\n")
